...
//finsh������մ������ݣ����?���ڴ����ж��ڷ����ʼ���finsh�߳̽����ʼ����л�ȡ��
...
void example_uart1_callback(LPUART_Type *base, lpuart_handle_t *handle, status_t status, void *userData)
{
    ...
    {
        rt_mb_send(uart_mb, example_rx_buffer);           // �����ʼ�
    }
...
//    BOARD_InitDebugConsole();
    ...
    // uart_rx_interrupt(DEBUG_UART, 1);
    
#endif
    
    NVIC_SetPriorityGrouping(((uint32_t)0x3));  //�����ж����ȼ�����
}
...
void rt_hw_console_output(const char *str)
{
    while(RT_NULL != *str)
    {
        ...
        uart_write_byte(DEBUG_UART, *str++);
    }
}
